...
const AppointmentForm = () => {
  ...
  useEffect(() => {
    const fetchDoctors = async () => {
      try {
        ...
        console.log(data.doctors); // Debugging line
      } catch (error) {
  ...
  const handleAppointment = async (e) => {
    ...
    try {
      ...
      toast.error(error.response?.data?.message || "Error submitting appointment.");
    }
  };
        ...
        <div>
          <select
            ...
            onChange={(e) => {
              ...
              setDoctor(""); // Clear doctor selection when department changes
            }}
          >
